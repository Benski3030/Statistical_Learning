...
psampler <- function (x, boot = 500, mean = 0, test_size = 100) {
    ...
    print(paste("The bootstrapped false positive rate is:",round(length(psub)/length(bootstrap),3)*100,"%"))
    return(df)
}

pvals <- psampler(our_population, boot = 1000, mean = 14.25, test_size = 1000)
